const FoodCard = (props) => {
  return (
    <div className=" flex flex-row   border-t border-stone-600 flex flex-col md:flex-row container mx-auto  mt-4">
      <img className="mt-6 max-w-[16rem]" src={props.img} alt="foot" />
